...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the full disease-90 Poincare pipeline")
    parser.add_argument("--root-id", default=ROOT_ID)
    parser.add_argument("--relation-mode", choices=["closure", "direct", "hybrid"], default="closure")
